...
<body>
	...
	<?php echo '<input type="text" value="' . $zeze['id'] . '" name="id">'?>
	 <form method="POST" action="updatepanel.php">
			<?php echo '<input type="text" value="' . $zeze['email'] . '" name="email">'?>
			<?php echo '<input type="text" value="' . $zeze['name'] . '" name="name">'?>
			<?php echo '<input type="text" value="' . $zeze['surname'] . '" name="surname">'?>
			<?php echo '<input type="text" value="' . $zeze['password'] . '" name="password">'?>
			<?php echo '<input type="text" value="' . $zeze['id'] . '" name="id">'?>
